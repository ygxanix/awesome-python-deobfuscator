    ...
    try:
        ...
        while num < 1:
            for i, char in enumerate(x):
                if i == 0:
                    print('\r%s%s%s%s' % (rg, char.lower(), rd, x[1:]), end=' ')
                    sys.stdout.flush()
                else:
                    if i == 1:
                        okklah = x[0].lower()
                        print('\r%s%s%s%s%s%s' % (rd, okklah, pt, char.lower(), rg, x[2:]), end=' ')
                        sys.stdout.flush()
                    elif i == i:
                        okklah = x[0:i].lower()
                        print('\r%s%s%s%s%s%s' % (rd, okklah, pt, char.lower(), rg, x[i + 1:]), end=' ')
                        sys.stdout.flush()
                    time.sleep(0.07)
...
def unmarsh():
    ...
    ask = input(h + '[' + k + '?' + h + ']' + p + ' Decompile Again? y/t ')
    if ask == 'y' or ask == 'Y':
        menu()
    elif ask == 't' or ask == 'T':
        sys.exit()
...
def pyc():
    ...
    if ask == 'y' or ask == 'Y':
        ...
        input(m + '[' + p + '^' + m + ']' + p + ' Press Enter to Return to the menu ')
        os.system('clear')
        menu()
def unpyc():
    ...
    ask = input(m + '[' + p + '?' + m + ']' + p + ' Decompile Again? y/t >> ')
    if ask == 'y' or ask == 'Y':
        menu()
    elif ask == 't' or ask == 'T':
        sys.exit()
