...
import pyfiglet
def banner(Marwan):
    ascii_banner = pyfiglet.figlet_format(f'''{Marwan}''')
    print(ascii_banner)
...
open('Marwan.py','w').write('exec(__import__("marshal").loads(__import__("zlib").decompress(__import__("base64").b64decode('+str(__import__("base64").b64encode(__import__("zlib").compress(__import__('marshal').dumps(compile(r'''
try:
    if __name__=='__main__':
        ...
        try:__import__('os').unlink('Marwan.py')
        except:pass
        __import__('sys').exit(1)
    from marshal import *
except:
...
def loads(bytes):
    global {4}
    open('Team_TC4.py'.format('{0}',{4},'{0}'),'w').write("# marshal dump by @Marwan\n# file name: [{0}.py] ({1} - {2})\n# layers count -> " + str({4}) + "\nimport marshal\nexec(marshal.loads(" + str(bytes) + "))\n")
...
marshal+=r'''
try:
    __import__('Marwan').__spec__ = __import__('marshal').__spec__
    __import__('sys').modules['marshal'] = __import__('sys').modules['Marwan']
    __import__('marshal').loads.__name__ = 'loads'
    __import__('marshal').loads.__module__ = 'marshal'
    __import__('builtins').compile = __import__('Marwan').compile
    __import__('builtins').compile.__name__ = 'compile'
    __import__('builtins').compile.__module__ = 'builtins'
    __builtins__ = __import__('builtins')
except:
    __import__('os').unlink(r'{}/Marwan.py')
    __import__('sys').exit(1)
...
marshal+="""\n\n__import__('os').unlink(r'{}/Marwan.py')""".format(__pypath__).encode('utf8')
...
try:
    exec('import marshal;exec(marshal.loads(' + str(__import__('marshal').dumps(compile(marshal, '<Marwan>', 'exec'))) + "), globals())",globals())
...
try:
    ...
    pass
try:
    __import__('os').unlink(r'{}/Marwan.py'.format(__pypath__))
except:
    pass
__import__('sys').exit()
