...
Copyright=['@LAEGER_MO','@LAEGER_MO_1']
...
if foo:
	...
	cobe="#Dec bY C4 TEAM: @LAEGER_MO  oN: @LAEGER_MO🌪️ .\n"
...
file="marshal.py"
سيو='\033[1;32m'
#cons.print('[yellow]if not complet Enter ok:[/yellow]  '+str(layrs)+'\n[blue][chos `try`to re declmpile[/blue]')
na=input(سيو+"\x1b[1;31m[\x1b[1;31m𝐶4 𖠏Team\x1b[1;31m] \033[1;97m> - Enter File marshal: ")
d=1
#x=1
