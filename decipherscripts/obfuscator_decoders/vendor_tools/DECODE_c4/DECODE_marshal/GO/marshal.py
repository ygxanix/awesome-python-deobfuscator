...
def animation2(ddd):
    for e in ddd + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.0000000002)
def bytos(seoDEC):
	source=seoDEC
	...
	if file_type == "zip":
	    ...
	    # print(source)
	     ...
	     #  if '(lambda'  in source :
	       ...
	       #print(outo)
	       animation('decode marshal TAEM PLYA')
...
na=input("\x1b[1;31m[\x1b[1;31m𝐶4 𖠏Team\x1b[1;31m] \033[1;97m> - Enter File marshal_3.9 : ")
d=1
animation
animation
animation
