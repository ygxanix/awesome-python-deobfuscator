...
int python_38_map(int id)
{
    ...
    case 53: return Pyc::BEGIN_FINALLY;
    ...
    case 158: return Pyc::BUILD_TUPLE_UNPACK_WITH_CALL_A;
    case 160: return Pyc::LOAD_METHOD_A;
    case 161: return Pyc::CALL_METHOD_A;
    case 162: return Pyc::CALL_FINALLY_A;
    case 163: return Pyc::POP_FINALLY_A;
    default: return Pyc::PYC_INVALID_OPCODE;
    }
}

int python_38_unmap(int id)
{
    switch (id) {
    case Pyc::BEFORE_ASYNC_WITH: return 52;
    case Pyc::BEGIN_FINALLY: return 53;
    ...
    case Pyc::BUILD_TUPLE_UNPACK_WITH_CALL_A: return 158;
    case Pyc::CALL_FINALLY_A: return 162;
    ...
    case Pyc::POP_FINALLY_A: return 163;
