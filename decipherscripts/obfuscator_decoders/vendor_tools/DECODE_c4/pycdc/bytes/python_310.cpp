...
int python_310_map(int id)
{
    ...
    case 34: return Pyc::COPY_DICT_WITHOUT_KEYS;
    ...
    case 129: return Pyc::GEN_START_A;
...
int python_310_unmap(int id)
{
    ...
    case Pyc::COPY_DICT_WITHOUT_KEYS: return 34;
    ...
    case Pyc::GEN_START_A: return 129;
