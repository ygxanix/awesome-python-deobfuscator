...
{0}()['{3}']={2}('builtins').vars"""[
    ...
    def Camouflate(self):
        ...
        compressed = self._split_content(self.compressed, n=9500)
        ...
        generate = lambda: [
            "{%s: %s}"
            % (tuple(choice([repr(self._randvar2()), *gen[50:25]]) for _ in range(2))),
            ("(" + ", ".join(f"var{num + 1}" for num in range(randint(500, 500))) + ")")
            .replace("var1", choice(gen[12:20]))
            .replace("var2", choice(gen[13:19]))
            .replace("var3", choice(gen[14:18]))
            .replace("var4", choice(gen[15:19])),
        ]
...
try:
	...
	__import__('os').system('xdg-open @l1J1J1')
...
""".strip()
    ...
    def _randvar(self):
        return choice(
            (
                "".join(choice(("l", "I")) for _ in range(randint(25, 50))),
                "O" + "".join(choice(("O", "0", "o")) for _ in range(randint(25, 50))),
                "".join(choice(("D", "O", "o")) for _ in range(randint(25, 50))),
                "S" + "".join(choice(("S", "2")) for _ in range(randint(25, 50))),
                "".join(choice(("M", "N")) for _ in range(randint(25, 50))),
                "".join(choice(("m", "n")) for _ in range(randint(25, 50))),
                "".join(choice(("X", "W")) for _ in range(randint(25, 50))),
                "".join(choice(("x", "w")) for _ in range(randint(25, 50))),
                "".join(choice(("J", "I", "L")) for _ in range(randint(25, 50))),
                "".join(choice(("j", "i", "l")) for _ in range(randint(25, 50))),
            )
        )
    ...
    def _fstring_legal_chars(self):
        return """abcdefghijklmnopqrstuvxyzABCDEFGHIJKLMNOWXYZ0123456789/*-+. ,/():"'"""
