...
def show_code(source: str):
    syntax = Syntax(source, "python", line_numbers=True)
    console.print(syntax)
    
def dec_kfl(input_file, output_file):
    try:
        with open(input_file, "r") as file:
            original_code = file.read()
            decoded_code = original_code.replace("exec(marshal.loads(zlib.decompress(base64.b64decode(code.encode()))))","print(zlib.decompress(base64.b64decode(code.encode())))")
            temp_file = "Plya_Team.py"
            with open(temp_file, "w") as temp_decoded_file:
                temp_decoded_file.write(decoded_code)
            os.system(f'python {temp_file} > {output_file}')
            aa = open(output_file,'r').read()
            a = open(output_file,'w').write(f'import marshal\nexec(marshal.loads({aa}))')
            with open(output_file, 'r') as decoded_file:
                final_code = decoded_file.read()
            print('')
            show_code(final_code)
            print('')
            console.print(f"[bold green] - Decode Done √ - Save As {output_file}[/bold green]")
            os.remove(temp_file)
    except FileNotFoundError:
        console.print("[bold red]File Not Found It !")
        
def dec_marshal3_9(input_file, output_file):
    try:
        with open(input_file, "r") as file:
            original_code = file.read()
            decoded_code = open(input_file,'w').write(f'{input_file}\n')
            temp_file = "Plya_Team.py"
            with open(temp_file, "w") as temp_decoded_file:
                temp_decoded_file.write(decoded_code)
            os.system(f'python3.9 {temp_file}')
            with open(output_file, 'r') as decoded_file:
                final_code = decoded_file.read()
            print('')
            show_code(final_code)
...
def dec_obf_lambda(input_file, output_file):
	best = input_file
	with open(best,'r') as ll:
		besto = ll.read()
	if '''import marshal\nexec(marshal.loads(b''' in besto:
		aa = '''#'''
		dec(best,aa,input_file, output_file)		
	elif '''_ = lambda __ : __import__('base64').b64decode(__[::-1]);''' in besto:
		aa = '''_ = lambda __ : __import__('base64').b64decode(__[::-1]);'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('base64').b32decode(__[::-1]);''' in besto:
		aa = '''_ = lambda __ : __import__('base64').b32decode(__[::-1]);'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('base64').b16decode(__[::-1]);''' in besto:
		aa = '''_ = lambda __ : __import__('base64').b16decode(__[::-1]);'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('zlib').decompress(__[::-1]);''' in besto:
		aa = '''_ = lambda __ : __import__('zlib').decompress(__[::-1]);'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b64decode(__[::-1]));''' in besto:
		aa = '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b64decode(__[::-1]));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b32decode(__[::-1]));''' in besto:
		aa = '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b32decode(__[::-1]));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b16decode(__[::-1]));''' in besto:
		aa = '''_ = lambda __ : __import__('zlib').decompress(__import__('base64').b16decode(__[::-1]));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b64decode(__[::-1])));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b64decode(__[::-1])));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b32decode(__[::-1])));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b32decode(__[::-1])));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b16decode(__[::-1])));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b16decode(__[::-1])));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b64decode(__[::-1])))));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b64decode(__[::-1])))));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b32decode(__[::-1])))));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b32decode(__[::-1])))));'''
		dec(best,aa,input_file, output_file)
	elif '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b16decode(__[::-1])))));''' in besto:
		aa = '''_ = lambda __ : __import__('marshal').loads(__import__('gzip').decompress(__import__('lzma').decompress(__import__('zlib').decompress(__import__('base64').b16decode(__[::-1])))));'''
		dec(best,aa,input_file, output_file)
		
def dec(best,aa,input_file, output_file):
	#!/usr/bin/python3
		...
		if type(source) == str:
		       ...
		       if 'bytes([' in source:
		       	if 'exec(marshal' in source:
		       		...
		       		bytos(source)
		       if len(source) > 250:		       	
		       	print(f'\x1b[1;97m [\x1b[1;94m> - Layer Decoded √ - Save As  {output_file}\x1b[1;97m]\x1b[1;97m \x1b[1;97m');print('')
		       	m=f'''# Decode by Plya Team - DecodeX\n# Version : V7 Beta !\nimport lzma\nimport zlib\nimport codecs\nimport base64\n{aa}'''+"\n"
		        save(m+source,'w','ou')
		        decoder(la,lo);exit()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=' - Plya Team - DecodeX The Best Decode Tool In World !')
    parser.add_argument('-i', '--input', help=' - Input File Path Error !', required=True)
    parser.add_argument('-o', '--output', help=' - Output File Path Error !', required=True)
    parser.add_argument('-t', '--type', help=' - Type Not Found It !', type=str, required=True)
    parser.add_argument('-v', '--version', help=' - Version Not Found It !', type=str, required=True)
    args = parser.parse_args()
    if args.type == 'kfl':
        dec_kfl(args.input, args.output)
    elif args.type == 'marshal' and args.version == '3.9':
        dec_marshal3_9(args.input, args.output)        
    if args.type == 'obf_lambda' and args.version == '3.9':
        dec_obf_lambda(args.input, args.output)        
    else:
        console.print("[bold red] - Erorr In Usage Bro !![/bold red]")